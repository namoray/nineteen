llm_models = [
    ...
    {
        "id": "chat-llama-3-2-3b",
        "name": "Meta: Llama 3.2 3B Instruct",
        "created": 8192,
        "description": "Meta's latest class of model (Llama 3.2) launched with a variety of sizes & flavors. This 3B instruct-tuned version is optimized for high quality dialogue usecases, and rapid inference.\n\nIt has demonstrated strong performance compared to leading closed-source models in human evaluations.",
        "context_length": 8192,
        "architecture": {"modality": "text->text", "tokenizer": "Llama3", "instruct_type": "llama3"},
        "pricing": {"prompt": "0.000000001", "completion": "0.000000001", "image": "0", "request": "0"},
    },
